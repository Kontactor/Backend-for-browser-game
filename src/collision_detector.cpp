...
size_t GathererProvider::ItemsCount() const {
    return items_.size();
}

void GathererProvider::AddItem(Item item) {
    items_.emplace_back(item);
}

Item GathererProvider::GetItem(size_t idx) const {
    return items_.at(idx);
}

size_t GathererProvider::GatherersCount() const {
    return gatherers_.size();
}

void GathererProvider::AddGatherer(Gatherer gatherer) {
    gatherers_.emplace_back(gatherer);
}

Gatherer GathererProvider::GetGatherer(size_t idx) const {
