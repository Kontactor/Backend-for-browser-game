...
# ENTRYPOINT ["./app/game_server", "-c", "/app/data/config.json", "-w", "/app/static/", "-t", "50", "--state-file", "/app/data/state", "--save-state-period", "100"]
...
# ENTRYPOINT ["./app/game_server -c ../data/config.json -w ../static/ -t 50 --state-file ../data/state --save-state-period 100"]
